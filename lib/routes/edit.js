...
module.exports = function(app) {
    ...
    function reduceFormState(result, form) {
    ...
    const handleForms = function(configForms, res) {
        return function(error, formStates) {
            if (!formStates.other.length) {
                ...
                const data = formStates.success.reduce(reduceFormState, {});
    ...
    function handleBody(body, res) {
        ...
        const configForms = createForms(body, settings, credentials);
    ...
    app.post('/edit', function(req, res) {
        ...
        form.parse(req, function (err, originalFields/* , files*/) {
            ...
            const parsedFields = querystring.parse(querystring.stringify(originalFields));
